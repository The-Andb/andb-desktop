const { DesktopStorageStrategy } = require('./electron/storage/strategy/desktop-storage.strategy');
  ...
  try {
    ...
    if (exports.length > 0) {
      ...
      if (!exports[0].ddl_content) {
          ...
          const fullPath = p.join(strategy.projectBaseDir, exports[0].file_path);
