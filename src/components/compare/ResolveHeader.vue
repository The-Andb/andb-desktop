...
<template>
  <header
    class="h-16 flex items-center justify-between border-b border-slate-800 px-6 bg-panel-dark z-20 shrink-0"
  >
    <div class="flex items-center gap-4">
      <div
        class="bg-primary-600 size-8 rounded flex items-center justify-center text-white shadow-lg shadow-primary-500/20"
      >
        <span class="material-symbols-outlined text-xl">database</span>
      </div>
      <div>
        <h1 class="text-white text-sm font-bold leading-none tracking-wide">
          AnDB Conflict Resolution
        </h1>
    ...
    <div class="flex items-center gap-3">
      ...
      >
        ...
        {{ $t('compare.conflictsRemaining', { count: conflictCount }) }}
      </div>
