...
<template>
  <div v-if="isOpen" class="fixed inset-0 z-[150] flex items-center justify-center p-4">
    ...
    >
      ...
      <!-- Danger Notice -->
      <div
        class="mx-8 mt-2 p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex items-start gap-3"
      >
        ...
        <div>
          ...
          <p class="text-[11px] font-bold text-gray-600 dark:text-gray-400 leading-tight">
            This action is irreversible. All connections and pairs within
            <span class="font-black text-gray-900 dark:text-gray-200">"{{ projectName }}"</span>
            will be lost.
          </p>
        </div>
      </div>
      ...
      <div class="px-8 pt-6 pb-2">
        ...
        >
          Type
          <span class="font-black text-gray-900 dark:text-white select-all">{{ projectName }}</span>
          to confirm
        </label>
        <div class="relative">
          <input
