        ...
        <div class="space-y-0.5">
          ...
          >
            ...
            <Monitor
              ...
              "
            />
            <span class="text-[11px] font-black uppercase tracking-widest flex-1 text-left"
              >Sync System</span
            >
            <Check
              v-if="settings.theme === 'system'"
              class="w-3 h-3 animate-in zoom-in-50 duration-300"
            />
          </button>
          ...
          <button
            ...
            :style="
              settings.theme === t.id
                ? { backgroundColor: 'var(--bg-selection, rgba(var(--primary-500-rgb), 0.1))' }
                : {}
            "
          >
            <!-- Selection Accent -->
            ...
            <span
              class="text-[11px] font-black uppercase tracking-widest flex-1 text-left line-clamp-1"
