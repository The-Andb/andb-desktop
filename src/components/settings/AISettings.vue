...
const testAIConnection = async () => {
  ...
  try {
    ...
    if (err.includes('429')) {
      aiError.value =
        "Quota Exceeded: You've reached your Gemini limit. Please check your plan in Google AI Console. ☕️"
    ...
    >
      ...
      <div class="space-y-1">
        <h2 class="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">
          {{ $t('settings.ai.title') || 'AI DBA Assistant (Beta)' }}
        </h2>
        <p class="text-sm text-gray-500 leading-relaxed max-w-xl">
          Unlock deep schema analysis, automated risk assessment, and natural language DBA
          troubleshooting powered by
          <span class="font-bold text-primary-600 dark:text-primary-400">{{
            getModelLabel(settings.aiModelVersion)
          }}</span
          >.
        </p>
      </div>
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="flex-1">
            ...
            <div class="text-[11px] text-emerald-800/60 dark:text-emerald-400/60 font-medium">
              Your AI DBA Assistant is ready to help.
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex-1">
            ...
            <div class="text-[11px] text-red-800/60 dark:text-red-400/60 font-medium line-clamp-2">
              {{ aiError }}
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div class="space-y-4">
          <div class="flex items-start gap-4">
            ...
            <div>
              <div
                class="text-xs font-bold text-gray-900 dark:text-white uppercase leading-none mb-1"
              >
                Schema Change Review
              </div>
              <p class="text-[10px] text-gray-500 font-medium leading-relaxed">
                Automated analysis of DDL changes with risk level assessment.
              </p>
            </div>
          </div>
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-[10px] text-gray-500 font-medium leading-relaxed">
                Natural language interface to ask about complex table patterns and FK graphs.
              </p>
            </div>
          </div>
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-[10px] text-gray-500 font-medium leading-relaxed">
                Understand the intent of schema changes beyond text comparison.
              </p>
            </div>
          </div>
        </div>
