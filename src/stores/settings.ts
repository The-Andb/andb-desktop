...
export const themeOptions: ThemeOption[] = [
  {
    ...
    label: 'Refined Light',
    dark: false,
    preview: { main: '#ffffff', sidebar: '#f9fafb' }
  },
  {
    id: 'github-light',
    label: 'GitHub Light',
    dark: false,
    preview: { main: '#ffffff', sidebar: '#f6f8fa' }
  },
  {
    id: 'solarized-light',
    label: 'Solarized Light',
    dark: false,
    preview: { main: '#fdf6e3', sidebar: '#eee8d5' }
  },
  {
    id: 'nord-light',
    label: 'Nord Light',
    dark: false,
    preview: { main: '#eceff4', sidebar: '#e5e9f0' }
  },
  {
    id: 'night-owl-light',
    label: 'Night Owl Light',
    dark: false,
    preview: { main: '#fbfbfb', sidebar: '#f0f0f0' }
  },
  { id: 'dark', label: 'Pro Dark', dark: true, preview: { main: '#111827', sidebar: '#1f2937' } },
  {
    ...
    dark: true,
    preview: { main: '#002b36', sidebar: '#073642' }
  },
  {
    id: 'night-owl-dark',
    label: 'Night Owl Dark',
    dark: true,
    preview: { main: '#011627', sidebar: '#01111d' }
  },
  { id: 'dracula', label: 'Dracula', dark: true, preview: { main: '#282a36', sidebar: '#21222c' } },
  {
    ...
    label: 'One Dark',
    dark: true,
    preview: { main: '#282c34', sidebar: '#21252b' }
  },
  {
    id: 'monokai',
    label: 'Monokai Pro',
    dark: true,
    preview: { main: '#2d2a2e', sidebar: '#221f22' }
  },
  { id: 'nord', label: 'Nord', dark: true, preview: { main: '#2e3440', sidebar: '#242933' } },
  {
    ...
    label: 'GitHub Dark',
    dark: true,
    preview: { main: '#0d1117', sidebar: '#010409' }
  }
]
