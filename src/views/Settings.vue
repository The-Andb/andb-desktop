  ...
  <MainLayout :title="$t('settings.title')">
    <main class="flex h-full bg-white dark:bg-gray-950 overflow-hidden">
      ...
      <aside class="w-72 border-r border-gray-100 dark:border-gray-800 flex flex-col shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto px-4 space-y-1.5 custom-scrollbar">
          ...
          >
            ...
            />
            <span class="text-xs font-bold uppercase tracking-widest leading-tight block">{{
              cat.label
            }}</span>
            <div
      ...
      <div class="flex-1 overflow-y-auto p-10 custom-scrollbar">
        <div
          :class="
            activeCategory === 'templates' || activeCategory === 'environments'
              ? 'w-full'
              : 'max-w-6xl mx-auto'
          "
        >
          ...
          <div
            v-if="activeCategory === 'environments'"
            ...
            <div class="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-widest opacity-70">
                  Define the global topology of your infrastructure
                </p>
              </div>
            </div>
            <div class="w-full">
...
const categories = computed(() => [
  ...
  {
    id: 'environments',
    label: t('settings.categories.environments', 'Master Environments'),
