CREATE FUNCTION `d2022_genDeletedItemForConferenceMember`(pnChannelID BIGINT(11) ,pnMemberId BIGINT(11) ,pnUserId BIGINT(11) ,pnDeleteDate DOUBLE(13,3) ) RETURNS INT BEGIN
  --
