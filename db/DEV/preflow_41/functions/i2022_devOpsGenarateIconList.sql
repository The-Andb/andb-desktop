CREATE FUNCTION `i2022_devOpsGenarateIconList`(vBaseLink VARCHAR(255) ,pvDelimiter VARCHAR(5) ,vIconList TEXT ) RETURNS INT READS SQL DATA DETERMINISTIC BEGIN
  --
