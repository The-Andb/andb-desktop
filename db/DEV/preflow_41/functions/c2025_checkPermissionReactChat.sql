CREATE FUNCTION `c2025_checkPermissionReactChat`(pnChannelId BIGINT(20) ,pnUserId BIGINT(20) ,pvMessageUid VARCHAR(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci ) RETURNS DOUBLE BEGIN
