CREATE FUNCTION `adm2026_listOfUserCount`(pvIds TEXT ,bIsNoGroup TINYINT(1) ,vGroupIds TEXT ,pnGroupFilterType TINYINT(1) ,vKeyword VARCHAR(256) -- search ON field: email & account_3rd_emails ,pbAccountTypes TINYINT(1) -- 0: Google 1: Yahoo 2: iCloud 3: Other ,pbSubscriptionTypes TINYINT(1) -- 0: Standard 1: Premium 2: Pro ,pdLastUsedStart DOUBLE(13, 3) ,pdLastUsedEnd DOUBLE(13, 3) ,pdJoinDateStart DOUBLE(13, 3) ,pdJoinDateEnd DOUBLE(13, 3) ,pvMigrationStatus VARCHAR(20) -- 0: NOT migrate 1: CREATE new ON DB4.0 2: Migrated ,pvPlatformIds VARCHAR(256) ,pvPlatformFilterType VARCHAR(20) ,pbFloMacUpdate TINYINT(1) ,pvFloMacFilterType VARCHAR(20) ,pbIsInternal TINYINT(1) ) RETURNS INT BEGIN
  --
