CREATE FUNCTION `d2025_generateDeletedItemForMember`(pvItemType VARCHAR(255) ,pnCollectionId BIGINT(11) ,pnItemId BIGINT(11) ,pvItemUid VARBINARY(1000) -- item_uid: depend ON item type ,pnDeleteDate DOUBLE(13,3) ,pvEmail VARCHAR(100) ) RETURNS INT BEGIN
  --
