CREATE FUNCTION `insertMultiEmailToGroup`(`pnGroupID` INT(11) ,`pvEmailList` TEXT ,`pvDelimiter` VARCHAR(5) ) RETURNS TEXT CHARSET latin1 READS SQL DATA DETERMINISTIC BEGIN
  --
