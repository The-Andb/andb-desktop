CREATE FUNCTION `c2022_checkPermissionActivity`(pnCollectionId BIGINT(20) ,pvObjectUid VARBINARY(1000) ,pvObjectType VARBINARY(50) ,pnUserId BIGINT(20) ) RETURNS TINYINT(1) BEGIN
