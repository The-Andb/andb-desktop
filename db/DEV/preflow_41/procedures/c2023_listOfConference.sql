CREATE PROCEDURE `c2023_listOfConference`(pvKeyword TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvEmails TEXT ,pnFilterType TINYINT(1) ,pvColIds TEXT ,pvChannelIDs TEXT ,pnUserId BIGINT(20) ,pvIDs TEXT ,pnModifiedGTE DOUBLE(14,4) ,pnModifiedLT DOUBLE(14,4) ,pnMinId BIGINT(20) ,pnVip TINYINT(1) ,pnPageSize INTEGER(11) ,pnPageNo INTEGER(11) ,pvSort VARCHAR(128)) BEGIN
  -- 
      ...
      ORDER BY
        (CASE
           ...
           WHEN (ifnull(pnPageNo, 0) > 0 OR (isnull(pnMinId) AND isnull(pnModifiedGTE)))
             ...
             CASE vFieldSort
               ...
               WHEN 'last_used'    THEN cc.last_used
        ...
        (CASE
           ...
           WHEN INSTR(vSort, "+") THEN
             ...
             CASE vFieldSort 
               --
               WHEN 'start_time'   THEN GREATEST(ifnull(ch.start_time, 0), cm.created_date, cc.last_used)
               WHEN 'action_time'  THEN ch.action_time
               WHEN 'created_date' THEN cm.created_date
               WHEN 'last_used'    THEN cc.last_used
               WHEN 'title'        THEN ifnull(cm.title, cc.title)
