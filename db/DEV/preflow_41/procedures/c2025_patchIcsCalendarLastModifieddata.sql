CREATE PROCEDURE `c2025_patchIcsCalendarLastModifieddata`( IN psUserEmail VARCHAR(255) -- NULL = UPDATE ALL, otherwise filter BY email (auto-prefixed WITH principals/users/)
)
main_block: BEGIN
