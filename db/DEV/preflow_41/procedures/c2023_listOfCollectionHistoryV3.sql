CREATE PROCEDURE `c2023_listOfCollectionHistoryV3`(pnCollectionId BIGINT(20) ,pvObjectUid VARBINARY(1000) ,pnUserId BIGINT(20) ,pvIDs TEXT ,pnModifiedGTE DOUBLE(14,4) ,pnModifiedLT DOUBLE(14,4) ,pnMinId BIGINT(20) ,pnPageSize INTEGER(11) ,pnPageNo INTEGER(11) ,pvSort VARCHAR(128) ,pnIncludeShared TINYINT(1)) BEGIN
  -- 
