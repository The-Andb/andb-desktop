CREATE PROCEDURE `c2023_createChannel`(pnUserId BIGINT(20) ,pvUid VARBINARY(1000) ,pvEmail VARCHAR(100) ,pvTitle VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvShareTitle VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvDescription VARCHAR(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvAvatar TEXT ,pnVip TINYINT(1) ,pvRoomUrl VARCHAR(2000) ,pnCreatedDate DOUBLE(13,3) ,pnUpdatedDate DOUBLE(13,3) ,pnEnableChatHistory TINYINT(1)) BEGIN
  --
  ...
  -- CHECK existed creator
    ...
    (user_id, title, uid, room_url, enable_chat_history, created_date, updated_date, last_used)
    VALUES
    (pnUserId, COALESCE(pvShareTitle, pvTitle, ''), pvUid, ifnull(pvRoomUrl, ''), nEnableChatHistory, pnCreatedDate, pnUpdatedDate, pnUpdatedDate);
    #
