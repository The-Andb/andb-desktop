    ...
    JOIN (
      ...
      ,ch.meeting_id
       ...
       WHERE ch.user_id = pnUserId
         ...
         AND (ch.status NOT IN (14, 20, 21) OR ch.created_by_server = 1)
       GROUP BY CASE 
