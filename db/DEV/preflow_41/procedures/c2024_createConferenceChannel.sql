CREATE PROCEDURE `c2024_createConferenceChannel`(pnUserId BIGINT(20) ,pnCollectionId BIGINT(20) ,pvUid VARBINARY(1000) ,pvEmail VARCHAR(100) ,pvTitle VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvShareTitle VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvDescription VARCHAR(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pvAvatar TEXT ,pnVip TINYINT(1) ,pnStarTime DOUBLE(13,3) ,pvRoomUrl VARCHAR(2000) ,pnCreatedDate DOUBLE(13,3) ,pnUpdatedDate DOUBLE(13,3) ,pnEnableChatHistory TINYINT(1)) BEGIN
  --
