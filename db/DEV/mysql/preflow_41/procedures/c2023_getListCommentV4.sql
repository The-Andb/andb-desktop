CREATE PROCEDURE `c2023_getListCommentV4`(pnCollectionId BIGINT(20) ,pvObjectUid VARBINARY(1000) ,pnUserId BIGINT(20) ,pvUsername VARCHAR(100) ,pvCommentIds TEXT ,pnFilterType TINYINT(1) ,pnModifiedGTE DOUBLE(14,4) ,pnModifiedLT DOUBLE(14,4) ,pnMinId BIGINT(20) ,pnPageSize INTEGER(11) ,pnPageNo INTEGER(11) ,pvSort VARCHAR(128) ,pnBeforeGT DOUBLE(14,4) ,pnAfterLT DOUBLE(14,4) ) BEGIN
  --
