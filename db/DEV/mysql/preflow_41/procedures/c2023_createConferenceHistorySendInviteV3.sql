CREATE PROCEDURE `c2023_createConferenceHistorySendInviteV3`(pnChannelId BIGINT(20) ,pnUserId BIGINT(20) ,pnType TINYINT(1) ,pnStatus TINYINT(2) ,pvOrganizer VARCHAR(100) ,pvMemberForce TEXT ,pvMeetingId VARCHAR(1000) ,pvExMeetingId VARCHAR(1000) ,pnUpdatedDate DOUBLE(13,3)) BEGIN
  --
  --
