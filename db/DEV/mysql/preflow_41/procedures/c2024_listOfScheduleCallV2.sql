CREATE PROCEDURE `c2024_listOfScheduleCallV2`(pnChannelId BIGINT(20) ,pnExternalMettingIds TEXT ,pnPageSize INTEGER(11) ,pnPageNo INTEGER(11) ,pvSort VARCHAR(128) ,pnBeforeGT DOUBLE(14,4) ,pnAfterLT DOUBLE(14,4) ) BEGIN
