CREATE PROCEDURE `C2025_listOfCollectionShareTree`( pvIDs TEXT, pnMinId BIGINT (20), pnRemoveDeleted boolean, pvObjectTrash VARBINARY (250), pnIncludeSubCol TINYINT (1), pnModifiedGTE DOUBLE (14, 4), pnModifiedLT DOUBLE (14, 4), pnFilterCreatedDate DOUBLE (14, 4), pvObjectType VARBINARY (250), pnPageSize INTEGER (11), pnUserId BIGINT (20)
) BEGIN
  --
