CREATE PROCEDURE `c2025_createCollectionCommentV3`( pnID BIGINT(20) ,pnCollectionId BIGINT(20) ,pvObjectUid VARBINARY(1000) ,pvObjectHref TEXT ,pvObjectType VARBINARY(50) ,pnUserId BIGINT(20) ,pnActionTime DOUBLE(13,3) ,pvComment TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pnParentId BIGINT(20) ,pnCreatedDate DOUBLE(13,3) ,pnUpdatedDate DOUBLE(13,3) ,pvEmail VARCHAR(100) ,pbMention TINYINT(1) ,pnQuoteCommentId BIGINT(20) )
