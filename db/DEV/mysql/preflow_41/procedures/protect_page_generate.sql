CREATE PROCEDURE `protect_page_generate`(generateNew TINYINT(1) ,verifyCode TEXT ,`checksum` VARCHAR(128) ,timeCodeExpire INT(11) ,createdDate DOUBLE(13,3) ,updatedDate DOUBLE(13,3) ,nOffset INT(11) ,nLimit INT(11)) BEGIN
  --
