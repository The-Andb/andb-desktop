CREATE FUNCTION `backupc2024_checkPermissionActivity`(pnCollectionId BIGINT(20) ,pnKanbanId BIGINT(20) ,pvObjectUid VARBINARY(1000) ,pvObjectType VARBINARY(50) ,pnUserId BIGINT(20) ) RETURNS TINYINT(1) BEGIN
