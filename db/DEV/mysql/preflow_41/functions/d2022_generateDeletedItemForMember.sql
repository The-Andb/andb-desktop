CREATE FUNCTION `d2022_generateDeletedItemForMember`(pvItemType VARCHAR(255) ,pnCollectionId BIGINT(11) ,pnItemId BIGINT(11) ,pnDeleteDate DOUBLE(13,3) ) RETURNS INT BEGIN
  --
