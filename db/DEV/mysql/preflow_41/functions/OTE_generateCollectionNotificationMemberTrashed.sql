CREATE FUNCTION `OTE_generateCollectionNotificationMemberTrashed`( pnUserId BIGINT(20) ,pnCollectionId BIGINT(20) ,pnChannelId BIGINT(20) ) RETURNS TINYINT BEGIN
