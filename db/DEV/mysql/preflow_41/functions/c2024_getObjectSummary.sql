CREATE FUNCTION `c2024_getObjectSummary`(pvObjectUid VARBINARY(1000) ,pvObjectType VARBINARY(50) ) RETURNS VARCHAR(1000) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci BEGIN
  --
