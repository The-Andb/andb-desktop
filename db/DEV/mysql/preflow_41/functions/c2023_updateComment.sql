CREATE FUNCTION `c2023_updateComment`(pnID BIGINT(20) ,pnUserId BIGINT(20) ,pnActionTime DOUBLE(13,3) ,pvComment TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,pnUpdatedDate DOUBLE(13,3)) RETURNS BIGINT BEGIN
  --
