CREATE FUNCTION `d2022_generateDeletedItemSharedOmni`(pvItemType VARCHAR(255) ,pnCollectionId BIGINT(20) ,pnItemId BIGINT(20) -- item_id: depend ON item type ,pnDeleteDate DOUBLE(13,3) ,pnUserId BIGINT(20) -- owner ) RETURNS INT BEGIN
  --
