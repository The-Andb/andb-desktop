CREATE FUNCTION `c2022_checkPermissionComment`(nCommentId BIGINT(20) ,collectionId BIGINT(20) ,objectUid VARBINARY(1000) ,objectType VARBINARY(50) ,nUserId BIGINT(20) ) RETURNS TINYINT(1) BEGIN
